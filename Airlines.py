...
Label(fr2,text="BOOBALAN S(RCAS2021BAM008)",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
...
def airline():
    ...
    Button(root1,text="Show seats",font=("algerian",10),fg="white",bg="Orange",compound="center",command=flights).grid(row=6,columnspan=1)
    root1.mainloop()
